...
export function ApplySection() {
  ...
  return (
    <section id="apply" className="panel-crimson relative scroll-mt-20 overflow-hidden px-5 py-24 sm:px-8 md:py-36">
      <span
        aria-hidden
        className="pointer-events-none absolute -right-10 -bottom-16 select-none font-display text-[32vw] leading-none text-paper/[0.07] italic"
      >
        Apply
      </span>
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-14 lg:grid-cols-[1fr_1.05fr] lg:items-center">
        <Reveal>
          <div>
            ...
            <h2 className="mt-6 text-6xl leading-[0.95] text-balance text-paper sm:text-7xl md:text-8xl">
        ...
        <Reveal delay={120}>
          <div className="rounded-3xl bg-ink p-6 shadow-[0_50px_90px_-30px_oklch(0.08_0.05_20),inset_0_1px_0_oklch(1_0_0/0.08)] sm:p-9">
            {sent ? (
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  ...
                  <Field label="Phone">
                    <input required name="phone" autoComplete="tel" className={inputCls} />
                  </Field>
                </div>
